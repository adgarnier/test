...
class GameWindow:
    ...
    def draw_startup_screen(self):
        ...
        for i, ceo_type in enumerate(types):
            ...
            self.draw_text(ceo_type, rect.x + 20, rect.y + 10, self.small_font, self.WHITE)
            self.startup_buttons.append((rect, ceo_type))
    ...
    def draw_game_screen(self):
        ...
        if self.feedback:
            ...
            self.draw_text(self.feedback, 70, 260, self.font, self.GREEN)
    ...
    def draw_summary_screen(self):
        ...
        color = self.GREEN if self.won else self.RED
    ...
    async def main(self):
        ...
        while running:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if self.screen_state == "startup":
                        for rect, ceo_type in self.startup_buttons:
                            if rect.collidepoint(event.pos):
                                self.reset()
                                self.game_type(ceo_type)
            ...
            elif self.screen_state == "summary":
                self.draw_summary_screen()
